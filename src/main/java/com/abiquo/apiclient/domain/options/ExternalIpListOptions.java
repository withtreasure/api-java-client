...
public class ExternalIpListOptions extends BaseOptions
{
    protected ExternalIpListOptions(final Map<String, Object> queryParams)
    {
        super(queryParams);
    }
    ...
    public static class Builder extends BaseOptionsBuilder<Builder>
    {
        ...
        protected Map<String, Object> buildParameters()
        {
            ...
            putIfPresent("all", all, params);
            return params;
        }

        public ExternalIpListOptions build()
        {
            return new ExternalIpListOptions(buildParameters());
        }
